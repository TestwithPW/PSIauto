...
public class Test_guestuser2_when15min_are_left extends BASE2.BaseClass2_userside  {
	...
	@Test(priority=2)
	public void login_guest1() throws InterruptedException  {
...
//	}
	...
	@Test(priority=8)
	public void Listen_idea() throws InterruptedException  {
	...
	@Test(priority=16)
	public void Flag_user() throws InterruptedException  {
		Discuss_round disc= new Discuss_round(driver);
		disc._Flag_click();
...
//		disc.Flag_reason_check_click();
	...
	@Test(priority=17)
	public void Start_vote_click() throws InterruptedException  {
	...
	@Test(priority=18)
	public void vote_plus_click() throws InterruptedException  {
		Voting_round start_vote = new Voting_round(driver);
	...
	@Test(priority=20)
	public void Submit_vote_click() throws InterruptedException  {
		Voting_round start_vote = new Voting_round(driver);
	...
	@Test(priority=21)
	public void Vote_completed() throws InterruptedException  {
		Voting_round start_vote = new Voting_round(driver);
		start_vote.voting_comlpleted(driver);
		
	}
	@Test(priority=22)
	public void Final_summary_header() throws InterruptedException  {
		Final_summarypg FSpg = new Final_summarypg(driver);
		FSpg.summary_header(driver);

	}
	
//	@Test(priority=8,dependsOnMethods="Discuss")
//	public void Final_summary() throws InterruptedException  {
//		Final_summarypg fsp = new Final_summarypg(driver);
//		
//		fsp.summary_header(driver);
