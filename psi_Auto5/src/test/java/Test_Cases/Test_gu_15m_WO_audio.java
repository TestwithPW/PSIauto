...
import psi_POM.Edit_idea_modal;
...
public class Test_gu_15m_WO_audio extends BASE2.BaseClass2_userside  {
...
//	}
	...
	public void add_idea() throws InterruptedException  {
		Add_idea_b15 Aib = new Add_idea_b15(driver);
		Thread.sleep(5000);
		Aib.I_will_add_desc_click(driver);
		Aib.Type_desc(driver);
